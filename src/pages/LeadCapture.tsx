  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 p-4 sm:p-6 lg:p-8 animate-fade-in max-w-6xl mx-auto">
        {/* Modern Header */}
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card px-5 py-6 shadow-sm mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:px-7 sm:py-7">
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-primary">Prospecção</span>
              <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Captura de Leads</h1>
              <p className="mt-1 text-sm text-muted-foreground">Disparo em massa para novos contatos (API Oficial)</p>
            </div>
          </div>
