        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card px-5 py-6 shadow-sm sm:px-7 sm:py-7">
          ...
          <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-primary">Saldo</span>
                <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Créditos</h1>
