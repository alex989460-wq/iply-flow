        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card px-5 py-6 shadow-sm sm:px-7 sm:py-7">
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-primary">Licenças</span>
                <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Ativação de Apps</h1>
                <p className="mt-1 text-sm text-muted-foreground">Controle automatizado de licenças e MACs</p>
              </div>
            </div>
