  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div className="relative isolate overflow-hidden rounded-3xl border border-border/50 bg-card px-5 py-6 shadow-sm sm:px-7 sm:py-7">
          ...
          <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-primary">Sistema</span>
