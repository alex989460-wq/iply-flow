      ...
      <CardContent className="space-y-5">
        ...
        <div className="flex flex-wrap gap-6 items-center border-t pt-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm flex items-center gap-2"><img src={efiLogo} alt="Efí" className="w-4 h-4 rounded-[4px]" /> Aceitar Pix (Efí)</span>
          </div>
          <div className="flex items-center gap-2">
            <Switch
            ...
            />
            <span className="text-sm flex items-center gap-2"><img src={mpLogo} alt="Mercado Pago" className="w-4 h-4 rounded-[4px]" /> Aceitar Pix (Mercado Pago)</span>
          </div>
          <div className="flex items-center gap-2">
            <Switch checked={form.enable_cakto} onCheckedChange={(v) => setForm((f) => ({ ...f, enable_cakto: v }))} />
            <span className="text-sm flex items-center gap-2"><img src={caktoLogo} alt="Cakto" className="w-4 h-4 rounded-[4px]" /> Aceitar Cakto (link do plano)</span>
          </div>
        </div>
