...
-- ============================================================
ALTER TABLE public.activation_apps DROP CONSTRAINT IF EXISTS activation_apps_pkey;
ALTER TABLE public.activation_apps ADD CONSTRAINT activation_apps_pkey PRIMARY KEY (id);
ALTER TABLE public.activation_panel_credentials DROP CONSTRAINT IF EXISTS activation_panel_credentials_pkey;
ALTER TABLE public.activation_panel_credentials ADD CONSTRAINT activation_panel_credentials_pkey PRIMARY KEY (id);
ALTER TABLE public.activation_requests DROP CONSTRAINT IF EXISTS activation_requests_pkey;
ALTER TABLE public.activation_requests ADD CONSTRAINT activation_requests_pkey PRIMARY KEY (id);
ALTER TABLE public.ai_knowledge_candidates DROP CONSTRAINT IF EXISTS ai_knowledge_candidates_pkey;
ALTER TABLE public.ai_knowledge_candidates ADD CONSTRAINT ai_knowledge_candidates_pkey PRIMARY KEY (id);
ALTER TABLE public.ai_knowledge_entries DROP CONSTRAINT IF EXISTS ai_knowledge_entries_pkey;
ALTER TABLE public.ai_knowledge_entries ADD CONSTRAINT ai_knowledge_entries_pkey PRIMARY KEY (id);
ALTER TABLE public.ai_knowledge_items DROP CONSTRAINT IF EXISTS ai_knowledge_items_pkey;
ALTER TABLE public.ai_knowledge_items ADD CONSTRAINT ai_knowledge_items_pkey PRIMARY KEY (id);
ALTER TABLE public.ai_training_conversations DROP CONSTRAINT IF EXISTS ai_training_conversations_pkey;
ALTER TABLE public.ai_training_conversations ADD CONSTRAINT ai_training_conversations_pkey PRIMARY KEY (id);
ALTER TABLE public.ai_training_jobs DROP CONSTRAINT IF EXISTS ai_training_jobs_pkey;
ALTER TABLE public.ai_training_jobs ADD CONSTRAINT ai_training_jobs_pkey PRIMARY KEY (id);
ALTER TABLE public.auto_replies DROP CONSTRAINT IF EXISTS auto_replies_pkey;
...
ALTER TABLE public.billing_schedule DROP CONSTRAINT IF EXISTS billing_schedule_pkey;
...
ALTER TABLE public.bot_flow_sessions DROP CONSTRAINT IF EXISTS bot_flow_sessions_pkey;
ALTER TABLE public.bot_flow_sessions ADD CONSTRAINT bot_flow_sessions_pkey PRIMARY KEY (id);
ALTER TABLE public.bot_flows DROP CONSTRAINT IF EXISTS bot_flows_pkey;
ALTER TABLE public.bot_flows ADD CONSTRAINT bot_flows_pkey PRIMARY KEY (id);
ALTER TABLE public.bot_triggers DROP CONSTRAINT IF EXISTS bot_triggers_pkey;
ALTER TABLE public.bot_triggers ADD CONSTRAINT bot_triggers_pkey PRIMARY KEY (id);
ALTER TABLE public.broadcast_logs DROP CONSTRAINT IF EXISTS broadcast_logs_pkey;
ALTER TABLE public.broadcast_logs ADD CONSTRAINT broadcast_logs_pkey PRIMARY KEY (id);
ALTER TABLE public.cakto_processed_events DROP CONSTRAINT IF EXISTS cakto_processed_events_pkey;
ALTER TABLE public.cakto_processed_events ADD CONSTRAINT cakto_processed_events_pkey PRIMARY KEY (cakto_id);
ALTER TABLE public.crm_oficial_billing_schedule DROP CONSTRAINT IF EXISTS crm_oficial_billing_schedule_pkey;
ALTER TABLE public.crm_oficial_billing_schedule ADD CONSTRAINT crm_oficial_billing_schedule_pkey PRIMARY KEY (id);
ALTER TABLE public.crm_oficial_hidden_templates DROP CONSTRAINT IF EXISTS crm_oficial_hidden_templates_pkey;
ALTER TABLE public.crm_oficial_hidden_templates ADD CONSTRAINT crm_oficial_hidden_templates_pkey PRIMARY KEY (id);
ALTER TABLE public.crm_oficial_settings DROP CONSTRAINT IF EXISTS crm_oficial_settings_pkey;
ALTER TABLE public.crm_oficial_settings ADD CONSTRAINT crm_oficial_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.customer_backups DROP CONSTRAINT IF EXISTS customer_backups_pkey;
...
ALTER TABLE public.device_tokens DROP CONSTRAINT IF EXISTS device_tokens_pkey;
ALTER TABLE public.device_tokens ADD CONSTRAINT device_tokens_pkey PRIMARY KEY (id);
ALTER TABLE public.efi_charges DROP CONSTRAINT IF EXISTS efi_charges_pkey;
ALTER TABLE public.efi_charges ADD CONSTRAINT efi_charges_pkey PRIMARY KEY (id);
ALTER TABLE public.efi_settings DROP CONSTRAINT IF EXISTS efi_settings_pkey;
ALTER TABLE public.efi_settings ADD CONSTRAINT efi_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_billing_schedule DROP CONSTRAINT IF EXISTS evolution_billing_schedule_pkey;
ALTER TABLE public.evolution_billing_schedule ADD CONSTRAINT evolution_billing_schedule_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_contacts DROP CONSTRAINT IF EXISTS evolution_contacts_pkey;
ALTER TABLE public.evolution_contacts ADD CONSTRAINT evolution_contacts_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_conversation_state DROP CONSTRAINT IF EXISTS evolution_conversation_state_pkey;
ALTER TABLE public.evolution_conversation_state ADD CONSTRAINT evolution_conversation_state_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_messages DROP CONSTRAINT IF EXISTS evolution_messages_pkey;
ALTER TABLE public.evolution_messages ADD CONSTRAINT evolution_messages_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_presence DROP CONSTRAINT IF EXISTS evolution_presence_pkey;
ALTER TABLE public.evolution_presence ADD CONSTRAINT evolution_presence_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_settings DROP CONSTRAINT IF EXISTS evolution_settings_pkey;
ALTER TABLE public.evolution_settings ADD CONSTRAINT evolution_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.evolution_stickers DROP CONSTRAINT IF EXISTS evolution_stickers_pkey;
...
ALTER TABLE public.goals_settings DROP CONSTRAINT IF EXISTS goals_settings_pkey;
ALTER TABLE public.goals_settings ADD CONSTRAINT goals_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.message_logs DROP CONSTRAINT IF EXISTS message_logs_pkey;
ALTER TABLE public.message_logs ADD CONSTRAINT message_logs_pkey PRIMARY KEY (id);
ALTER TABLE public.panel_links DROP CONSTRAINT IF EXISTS panel_links_pkey;
ALTER TABLE public.panel_links ADD CONSTRAINT panel_links_pkey PRIMARY KEY (id);
ALTER TABLE public.payment_confirmations DROP CONSTRAINT IF EXISTS payment_confirmations_pkey;
...
ALTER TABLE public.pending_activation_data DROP CONSTRAINT IF EXISTS pending_activation_data_pkey;
ALTER TABLE public.pending_activation_data ADD CONSTRAINT pending_activation_data_pkey PRIMARY KEY (id);
ALTER TABLE public.pending_manual_renewals DROP CONSTRAINT IF EXISTS pending_manual_renewals_pkey;
ALTER TABLE public.pending_manual_renewals ADD CONSTRAINT pending_manual_renewals_pkey PRIMARY KEY (id);
ALTER TABLE public.pending_new_customers DROP CONSTRAINT IF EXISTS pending_new_customers_pkey;
ALTER TABLE public.pending_new_customers ADD CONSTRAINT pending_new_customers_pkey PRIMARY KEY (id);
ALTER TABLE public.pending_renewal_selections DROP CONSTRAINT IF EXISTS pending_renewal_selections_pkey;
...
ALTER TABLE public.quick_messages DROP CONSTRAINT IF EXISTS quick_messages_pkey;
ALTER TABLE public.quick_messages ADD CONSTRAINT quick_messages_pkey PRIMARY KEY (id);
ALTER TABLE public.reseller_access DROP CONSTRAINT IF EXISTS reseller_access_pkey;
ALTER TABLE public.reseller_access ADD CONSTRAINT reseller_access_pkey PRIMARY KEY (id);
ALTER TABLE public.reseller_access_codes DROP CONSTRAINT IF EXISTS reseller_access_codes_pkey;
ALTER TABLE public.reseller_access_codes ADD CONSTRAINT reseller_access_codes_pkey PRIMARY KEY (id);
ALTER TABLE public.reseller_api_settings DROP CONSTRAINT IF EXISTS reseller_api_settings_pkey;
ALTER TABLE public.reseller_api_settings ADD CONSTRAINT reseller_api_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.reseller_checkout_settings DROP CONSTRAINT IF EXISTS reseller_checkout_settings_pkey;
ALTER TABLE public.reseller_checkout_settings ADD CONSTRAINT reseller_checkout_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.servers DROP CONSTRAINT IF EXISTS servers_pkey;
ALTER TABLE public.servers ADD CONSTRAINT servers_pkey PRIMARY KEY (id);
ALTER TABLE public.user_evolution_instances DROP CONSTRAINT IF EXISTS user_evolution_instances_pkey;
...
ALTER TABLE public.vplay_servers DROP CONSTRAINT IF EXISTS vplay_servers_pkey;
ALTER TABLE public.vplay_servers ADD CONSTRAINT vplay_servers_pkey PRIMARY KEY (id);
ALTER TABLE public.webhook_logs DROP CONSTRAINT IF EXISTS webhook_logs_pkey;
ALTER TABLE public.webhook_logs ADD CONSTRAINT webhook_logs_pkey PRIMARY KEY (id);
ALTER TABLE public.xui_one_settings DROP CONSTRAINT IF EXISTS xui_one_settings_pkey;
ALTER TABLE public.xui_one_settings ADD CONSTRAINT xui_one_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.zap_responder_settings DROP CONSTRAINT IF EXISTS zap_responder_settings_pkey;
ALTER TABLE public.zap_responder_settings ADD CONSTRAINT zap_responder_settings_pkey PRIMARY KEY (id);
ALTER TABLE public.activation_panel_credentials DROP CONSTRAINT IF EXISTS activation_panel_credentials_user_id_panel_type_key;
...
ALTER TABLE public.billing_schedule DROP CONSTRAINT IF EXISTS unique_user_schedule;
...
ALTER TABLE public.bot_flow_sessions DROP CONSTRAINT IF EXISTS bot_flow_sessions_owner_id_phone_key;
ALTER TABLE public.bot_flow_sessions ADD CONSTRAINT bot_flow_sessions_owner_id_phone_key UNIQUE (owner_id, phone);
ALTER TABLE public.bot_triggers DROP CONSTRAINT IF EXISTS bot_triggers_user_id_trigger_type_key;
ALTER TABLE public.bot_triggers ADD CONSTRAINT bot_triggers_user_id_trigger_type_key UNIQUE (user_id, trigger_type);
ALTER TABLE public.broadcast_logs DROP CONSTRAINT IF EXISTS broadcast_logs_phone_template_unique;
...
ALTER TABLE public.crm_oficial_billing_schedule DROP CONSTRAINT IF EXISTS crm_oficial_billing_schedule_user_id_key;
ALTER TABLE public.crm_oficial_billing_schedule ADD CONSTRAINT crm_oficial_billing_schedule_user_id_key UNIQUE (user_id);
ALTER TABLE public.crm_oficial_hidden_templates DROP CONSTRAINT IF EXISTS crm_oficial_hidden_templates_unique;
...
ALTER TABLE public.crm_oficial_settings DROP CONSTRAINT IF EXISTS crm_oficial_settings_user_id_key;
...
ALTER TABLE public.efi_charges DROP CONSTRAINT IF EXISTS efi_charges_txid_key;
ALTER TABLE public.efi_charges ADD CONSTRAINT efi_charges_txid_key UNIQUE (txid);
ALTER TABLE public.efi_settings DROP CONSTRAINT IF EXISTS efi_settings_user_id_key;
ALTER TABLE public.efi_settings ADD CONSTRAINT efi_settings_user_id_key UNIQUE (user_id);
ALTER TABLE public.evolution_billing_schedule DROP CONSTRAINT IF EXISTS evolution_billing_schedule_user_id_key;
ALTER TABLE public.evolution_billing_schedule ADD CONSTRAINT evolution_billing_schedule_user_id_key UNIQUE (user_id);
ALTER TABLE public.evolution_contacts DROP CONSTRAINT IF EXISTS evolution_contacts_user_id_phone_key;
ALTER TABLE public.evolution_contacts ADD CONSTRAINT evolution_contacts_user_id_phone_key UNIQUE (user_id, phone);
ALTER TABLE public.evolution_conversation_state DROP CONSTRAINT IF EXISTS evolution_conversation_state_user_id_phone_key;
...
ALTER TABLE public.evolution_presence DROP CONSTRAINT IF EXISTS evolution_presence_user_id_phone_key;
ALTER TABLE public.evolution_presence ADD CONSTRAINT evolution_presence_user_id_phone_key UNIQUE (user_id, phone);
ALTER TABLE public.evolution_settings DROP CONSTRAINT IF EXISTS evolution_settings_user_id_key;
ALTER TABLE public.evolution_settings ADD CONSTRAINT evolution_settings_user_id_key UNIQUE (user_id);
ALTER TABLE public.goals_settings DROP CONSTRAINT IF EXISTS goals_settings_user_id_key;
ALTER TABLE public.goals_settings ADD CONSTRAINT goals_settings_user_id_key UNIQUE (user_id);
ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_user_id_key;
ALTER TABLE public.profiles ADD CONSTRAINT profiles_user_id_key UNIQUE (user_id);
ALTER TABLE public.reseller_access DROP CONSTRAINT IF EXISTS reseller_access_user_id_key;
ALTER TABLE public.reseller_access ADD CONSTRAINT reseller_access_user_id_key UNIQUE (user_id);
ALTER TABLE public.reseller_access_codes DROP CONSTRAINT IF EXISTS reseller_access_codes_code_key;
ALTER TABLE public.reseller_access_codes ADD CONSTRAINT reseller_access_codes_code_key UNIQUE (code);
ALTER TABLE public.reseller_api_settings DROP CONSTRAINT IF EXISTS reseller_api_settings_user_id_key;
ALTER TABLE public.reseller_api_settings ADD CONSTRAINT reseller_api_settings_user_id_key UNIQUE (user_id);
ALTER TABLE public.reseller_checkout_settings DROP CONSTRAINT IF EXISTS reseller_checkout_settings_api_key_key;
ALTER TABLE public.reseller_checkout_settings ADD CONSTRAINT reseller_checkout_settings_api_key_key UNIQUE (api_key);
ALTER TABLE public.reseller_checkout_settings DROP CONSTRAINT IF EXISTS reseller_checkout_settings_slug_key;
ALTER TABLE public.reseller_checkout_settings ADD CONSTRAINT reseller_checkout_settings_slug_key UNIQUE (slug);
ALTER TABLE public.reseller_checkout_settings DROP CONSTRAINT IF EXISTS reseller_checkout_settings_user_id_key;
ALTER TABLE public.reseller_checkout_settings ADD CONSTRAINT reseller_checkout_settings_user_id_key UNIQUE (user_id);
ALTER TABLE public.user_evolution_instances DROP CONSTRAINT IF EXISTS user_evolution_instances_instance_name_key;
...
ALTER TABLE public.xui_one_settings DROP CONSTRAINT IF EXISTS xui_one_settings_user_id_key;
ALTER TABLE public.xui_one_settings ADD CONSTRAINT xui_one_settings_user_id_key UNIQUE (user_id);
ALTER TABLE public.ai_knowledge_candidates DROP CONSTRAINT IF EXISTS ai_knowledge_candidates_status_check;
...
ALTER TABLE public.ai_training_conversations DROP CONSTRAINT IF EXISTS ai_training_conversations_source_check;
...
ALTER TABLE public.ai_training_jobs DROP CONSTRAINT IF EXISTS ai_training_jobs_kind_check;
...
ALTER TABLE public.billing_settings DROP CONSTRAINT IF EXISTS billing_settings_renewal_notification_target_check;
...
ALTER TABLE public.bot_triggers DROP CONSTRAINT IF EXISTS bot_triggers_trigger_type_check;
...
ALTER TABLE public.crm_oficial_hidden_templates DROP CONSTRAINT IF EXISTS crm_oficial_hidden_templates_target_check;
...
ALTER TABLE public.efi_charges DROP CONSTRAINT IF EXISTS efi_charges_status_check;
...
ALTER TABLE public.efi_settings DROP CONSTRAINT IF EXISTS efi_settings_environment_check;
...
ALTER TABLE public.evolution_messages DROP CONSTRAINT IF EXISTS evolution_messages_direction_check;
...
ALTER TABLE public.reseller_checkout_settings DROP CONSTRAINT IF EXISTS reseller_checkout_slug_format;
...
ALTER TABLE public.ai_knowledge_items DROP CONSTRAINT IF EXISTS ai_knowledge_items_merged_into_id_fkey;
...
ALTER TABLE public.billing_logs DROP CONSTRAINT IF EXISTS billing_logs_customer_id_fkey;
...
ALTER TABLE public.bot_flow_sessions DROP CONSTRAINT IF EXISTS bot_flow_sessions_flow_id_fkey;
...
ALTER TABLE public.broadcast_logs DROP CONSTRAINT IF EXISTS broadcast_logs_customer_id_fkey;
...
ALTER TABLE public.crm_oficial_hidden_templates DROP CONSTRAINT IF EXISTS crm_oficial_hidden_templates_user_id_fkey;
...
ALTER TABLE public.crm_oficial_settings DROP CONSTRAINT IF EXISTS crm_oficial_settings_user_id_fkey;
...
ALTER TABLE public.customers DROP CONSTRAINT IF EXISTS customers_created_by_profiles_fkey;
...
ALTER TABLE public.customers DROP CONSTRAINT IF EXISTS customers_plan_id_fkey;
...
ALTER TABLE public.customers DROP CONSTRAINT IF EXISTS customers_server_id_fkey;
...
ALTER TABLE public.evolution_stickers DROP CONSTRAINT IF EXISTS evolution_stickers_user_id_fkey;
...
ALTER TABLE public.payment_confirmations DROP CONSTRAINT IF EXISTS payment_confirmations_customer_id_fkey;
...
ALTER TABLE public.pending_new_customers DROP CONSTRAINT IF EXISTS pending_new_customers_plan_id_fkey;
...
ALTER TABLE public.pending_new_customers DROP CONSTRAINT IF EXISTS pending_new_customers_server_id_fkey;
...
ALTER TABLE public.pending_renewal_selections DROP CONSTRAINT IF EXISTS pending_renewal_selections_customer_id_fkey;
...
ALTER TABLE public.plans DROP CONSTRAINT IF EXISTS plans_created_by_fkey;
...
ALTER TABLE public.quick_messages DROP CONSTRAINT IF EXISTS quick_messages_created_by_fkey;
...
ALTER TABLE public.reseller_access DROP CONSTRAINT IF EXISTS reseller_access_parent_reseller_id_fkey;
...
ALTER TABLE public.reseller_checkout_settings DROP CONSTRAINT IF EXISTS reseller_checkout_settings_user_id_fkey;
...
ALTER TABLE public.servers DROP CONSTRAINT IF EXISTS servers_created_by_fkey;
...
ALTER TABLE public.zap_responder_settings DROP CONSTRAINT IF EXISTS zap_responder_settings_user_id_fkey;
...
-- ÍNDICES
-- ============================================================
CREATE UNIQUE INDEX IF NOT EXISTS activation_panel_credentials_user_id_panel_type_key ON public.activation_panel_credentials USING btree (user_id, panel_type);
CREATE INDEX IF NOT EXISTS ai_knowledge_candidates_user_status ON public.ai_knowledge_candidates USING btree (user_id, status);
CREATE INDEX IF NOT EXISTS ai_knowledge_candidates_embedding ON public.ai_knowledge_candidates USING hnsw (embedding vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_ai_kb_user ON public.ai_knowledge_entries USING btree (user_id, sort_order);
CREATE INDEX IF NOT EXISTS ai_knowledge_entries_embedding ON public.ai_knowledge_entries USING hnsw (embedding vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_ai_ki_usage ON public.ai_knowledge_items USING btree (user_id, usage_count DESC);
CREATE INDEX IF NOT EXISTS ai_ki_embedding_idx ON public.ai_knowledge_items USING hnsw (embedding vector_cosine_ops);
CREATE INDEX IF NOT EXISTS idx_ai_ki_user_status ON public.ai_knowledge_items USING btree (user_id, status, kind);
CREATE UNIQUE INDEX IF NOT EXISTS ai_training_conversations_dedup_idx ON public.ai_training_conversations USING btree (user_id, source, contact_phone, started_at, ended_at);
CREATE INDEX IF NOT EXISTS ai_training_conversations_user_analyzed ON public.ai_training_conversations USING btree (user_id, analyzed_at);
CREATE INDEX IF NOT EXISTS idx_ai_training_conversations_user_pending_created ON public.ai_training_conversations USING btree (user_id, created_at) WHERE (analyzed_at IS NULL);
CREATE INDEX IF NOT EXISTS ai_training_conversations_user_source ON public.ai_training_conversations USING btree (user_id, source);
CREATE INDEX IF NOT EXISTS ai_training_jobs_user ON public.ai_training_jobs USING btree (user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_auto_replies_user_enabled ON public.auto_replies USING btree (user_id, is_enabled);
CREATE INDEX IF NOT EXISTS idx_auto_replies_keyword ON public.auto_replies USING btree (trigger_keyword);
CREATE INDEX IF NOT EXISTS idx_billing_logs_sent_date_status_customer ON public.billing_logs USING btree (sent_date_br, whatsapp_status, customer_id);
CREATE UNIQUE INDEX IF NOT EXISTS billing_logs_one_sent_per_day_idx ON public.billing_logs USING btree (customer_id, billing_type, sent_date_br) WHERE (whatsapp_status = ANY (ARRAY['pending'::text, 'sent'::text]));
CREATE UNIQUE INDEX IF NOT EXISTS unique_user_schedule ON public.billing_schedule USING btree (user_id);
CREATE UNIQUE INDEX IF NOT EXISTS billing_settings_user_id_key ON public.billing_settings USING btree (user_id);
CREATE INDEX IF NOT EXISTS bot_flow_sessions_expires_idx ON public.bot_flow_sessions USING btree (expires_at);
CREATE INDEX IF NOT EXISTS bot_flow_sessions_owner_phone_idx ON public.bot_flow_sessions USING btree (owner_id, phone);
CREATE UNIQUE INDEX IF NOT EXISTS bot_flow_sessions_owner_id_phone_key ON public.bot_flow_sessions USING btree (owner_id, phone);
CREATE INDEX IF NOT EXISTS bot_flows_owner_idx ON public.bot_flows USING btree (owner_id);
CREATE UNIQUE INDEX IF NOT EXISTS bot_triggers_user_id_trigger_type_key ON public.bot_triggers USING btree (user_id, trigger_type);
CREATE INDEX IF NOT EXISTS idx_broadcast_logs_template_status ON public.broadcast_logs USING btree (template_name, last_status);
CREATE UNIQUE INDEX IF NOT EXISTS broadcast_logs_phone_template_unique ON public.broadcast_logs USING btree (phone_normalized, template_name);
CREATE UNIQUE INDEX IF NOT EXISTS crm_oficial_billing_schedule_user_id_key ON public.crm_oficial_billing_schedule USING btree (user_id);
CREATE UNIQUE INDEX IF NOT EXISTS crm_oficial_hidden_templates_unique ON public.crm_oficial_hidden_templates USING btree (user_id, template_name, language);
CREATE UNIQUE INDEX IF NOT EXISTS crm_oficial_settings_user_id_key ON public.crm_oficial_settings USING btree (user_id);
CREATE UNIQUE INDEX IF NOT EXISTS customers_created_by_checkout_code_key ON public.customers USING btree (created_by, checkout_code);
...
CREATE INDEX IF NOT EXISTS efi_charges_owner_idx ON public.efi_charges USING btree (owner_id);
CREATE INDEX IF NOT EXISTS efi_charges_customer_idx ON public.efi_charges USING btree (customer_id);
CREATE UNIQUE INDEX IF NOT EXISTS efi_charges_txid_key ON public.efi_charges USING btree (txid);
CREATE INDEX IF NOT EXISTS efi_charges_status_idx ON public.efi_charges USING btree (status);
CREATE UNIQUE INDEX IF NOT EXISTS efi_settings_user_id_key ON public.efi_settings USING btree (user_id);
CREATE UNIQUE INDEX IF NOT EXISTS evolution_billing_schedule_user_id_key ON public.evolution_billing_schedule USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_evo_contacts_needs_human ON public.evolution_contacts USING btree (user_id, needs_human) WHERE (needs_human = true);
CREATE UNIQUE INDEX IF NOT EXISTS evolution_contacts_user_id_phone_key ON public.evolution_contacts USING btree (user_id, phone);
CREATE UNIQUE INDEX IF NOT EXISTS evolution_conversation_state_user_id_phone_key ON public.evolution_conversation_state USING btree (user_id, phone);
CREATE UNIQUE INDEX IF NOT EXISTS idx_evolution_messages_user_external_unique ON public.evolution_messages USING btree (user_id, external_id) WHERE (external_id IS NOT NULL);
CREATE INDEX IF NOT EXISTS idx_evo_msg_user_instance ON public.evolution_messages USING btree (user_id, instance_name, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_evolution_messages_user_created_at_id ON public.evolution_messages USING btree (user_id, created_at, id);
CREATE INDEX IF NOT EXISTS idx_evo_msg_user_phone ON public.evolution_messages USING btree (user_id, phone, created_at DESC);
CREATE UNIQUE INDEX IF NOT EXISTS evolution_presence_user_id_phone_key ON public.evolution_presence USING btree (user_id, phone);
CREATE UNIQUE INDEX IF NOT EXISTS evolution_settings_user_id_key ON public.evolution_settings USING btree (user_id);
CREATE INDEX IF NOT EXISTS evolution_stickers_user_idx ON public.evolution_stickers USING btree (user_id, created_at DESC);
CREATE UNIQUE INDEX IF NOT EXISTS goals_settings_user_id_key ON public.goals_settings USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_message_logs_user_id ON public.message_logs USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_message_logs_status ON public.message_logs USING btree (status);
CREATE INDEX IF NOT EXISTS idx_message_logs_created_at ON public.message_logs USING btree (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_pmr_owner ON public.pending_manual_renewals USING btree (owner_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_pmr_locked_at ON public.pending_manual_renewals USING btree (locked_at);
CREATE INDEX IF NOT EXISTS idx_pending_renewal_phone ON public.pending_renewal_selections USING btree (phone_normalized, used, expires_at);
CREATE UNIQUE INDEX IF NOT EXISTS profiles_user_id_key ON public.profiles USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_reseller_access_parent ON public.reseller_access USING btree (parent_reseller_id);
CREATE UNIQUE INDEX IF NOT EXISTS reseller_access_user_id_key ON public.reseller_access USING btree (user_id);
CREATE UNIQUE INDEX IF NOT EXISTS reseller_access_codes_code_key ON public.reseller_access_codes USING btree (code);
CREATE UNIQUE INDEX IF NOT EXISTS reseller_api_settings_user_id_key ON public.reseller_api_settings USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_reseller_checkout_api_key ON public.reseller_checkout_settings USING btree (api_key);
CREATE INDEX IF NOT EXISTS idx_reseller_checkout_slug ON public.reseller_checkout_settings USING btree (slug);
CREATE UNIQUE INDEX IF NOT EXISTS reseller_checkout_settings_api_key_key ON public.reseller_checkout_settings USING btree (api_key);
CREATE UNIQUE INDEX IF NOT EXISTS reseller_checkout_settings_slug_key ON public.reseller_checkout_settings USING btree (slug);
CREATE UNIQUE INDEX IF NOT EXISTS reseller_checkout_settings_user_id_key ON public.reseller_checkout_settings USING btree (user_id);
CREATE UNIQUE INDEX IF NOT EXISTS user_evolution_instances_instance_name_key ON public.user_evolution_instances USING btree (instance_name);
CREATE UNIQUE INDEX IF NOT EXISTS user_roles_user_id_role_key ON public.user_roles USING btree (user_id, role);
CREATE INDEX IF NOT EXISTS idx_webhook_logs_user_created ON public.webhook_logs USING btree (user_id, created_at DESC);
CREATE UNIQUE INDEX IF NOT EXISTS xui_one_settings_user_id_key ON public.xui_one_settings USING btree (user_id);
CREATE INDEX IF NOT EXISTS idx_zap_responder_settings_selected_department_id ON public.zap_responder_settings USING btree (selected_department_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_zap_responder_settings_user_id ON public.zap_responder_settings USING btree (user_id) WHERE (user_id IS NOT NULL);
...
-- TRIGGERS
-- ============================================================
DROP TRIGGER IF EXISTS trg_activation_panel_credentials_updated_at ON public.activation_panel_credentials;
...
DROP TRIGGER IF EXISTS trg_ai_knowledge_candidates_updated ON public.ai_knowledge_candidates;
...
DROP TRIGGER IF EXISTS trg_ai_training_conversations_updated ON public.ai_training_conversations;
...
DROP TRIGGER IF EXISTS update_billing_schedule_updated_at ON public.billing_schedule;
...
DROP TRIGGER IF EXISTS trg_bot_flow_sessions_updated ON public.bot_flow_sessions;
...
DROP TRIGGER IF EXISTS trg_bot_flows_updated ON public.bot_flows;
...
DROP TRIGGER IF EXISTS update_bot_triggers_updated_at ON public.bot_triggers;
...
DROP TRIGGER IF EXISTS trg_crm_oficial_billing_schedule_updated_at ON public.crm_oficial_billing_schedule;
...
DROP TRIGGER IF EXISTS update_crm_oficial_hidden_templates_updated_at ON public.crm_oficial_hidden_templates;
...
DROP TRIGGER IF EXISTS update_crm_oficial_settings_updated_at ON public.crm_oficial_settings;
...
DROP TRIGGER IF EXISTS trigger_cleanup_backups ON public.customer_backups;
...
DROP TRIGGER IF EXISTS efi_charges_updated_at ON public.efi_charges;
...
DROP TRIGGER IF EXISTS efi_settings_updated_at ON public.efi_settings;
...
DROP TRIGGER IF EXISTS update_evolution_billing_schedule_updated_at ON public.evolution_billing_schedule;
...
DROP TRIGGER IF EXISTS update_evolution_conversation_state_updated_at ON public.evolution_conversation_state;
...
DROP TRIGGER IF EXISTS trg_evolution_settings_updated ON public.evolution_settings;
...
DROP TRIGGER IF EXISTS update_panel_links_updated_at ON public.panel_links;
...
DROP TRIGGER IF EXISTS create_reseller_access_trigger ON public.profiles;
...
DROP TRIGGER IF EXISTS grant_first_admin ON public.profiles;
CREATE TRIGGER grant_first_admin AFTER INSERT ON public.profiles FOR EACH ROW EXECUTE FUNCTION auto_grant_first_admin();
DROP TRIGGER IF EXISTS update_quick_messages_updated_at ON public.quick_messages;
...
DROP TRIGGER IF EXISTS update_reseller_access_updated_at ON public.reseller_access;
...
DROP TRIGGER IF EXISTS update_reseller_api_settings_updated_at ON public.reseller_api_settings;
...
DROP TRIGGER IF EXISTS trg_reseller_checkout_settings_updated_at ON public.reseller_checkout_settings;
...
DROP TRIGGER IF EXISTS update_vplay_servers_updated_at ON public.vplay_servers;
...
DROP TRIGGER IF EXISTS update_xui_one_settings_updated_at ON public.xui_one_settings;
...
-- POLICIES (RLS)
-- ============================================================
DROP POLICY IF EXISTS "Users can delete own activation_apps" ON public.activation_apps;
CREATE POLICY "Users can delete own activation_apps" ON public.activation_apps FOR DELETE TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users can insert own activation_apps" ON public.activation_apps;
...
DROP POLICY IF EXISTS "Users can update own activation_apps" ON public.activation_apps;
CREATE POLICY "Users can update own activation_apps" ON public.activation_apps FOR UPDATE TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users can view own activation_apps" ON public.activation_apps;
CREATE POLICY "Users can view own activation_apps" ON public.activation_apps FOR SELECT TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users manage own panel credentials" ON public.activation_panel_credentials;
...
DROP POLICY IF EXISTS "Users can delete own activation_requests" ON public.activation_requests;
...
DROP POLICY IF EXISTS "Users can view own activation_requests" ON public.activation_requests;
...
DROP POLICY IF EXISTS "own candidates" ON public.ai_knowledge_candidates;
...
DROP POLICY IF EXISTS "Users manage own ai_knowledge_entries" ON public.ai_knowledge_entries;
...
DROP POLICY IF EXISTS "own conversations" ON public.ai_training_conversations;
...
DROP POLICY IF EXISTS "own training jobs" ON public.ai_training_jobs;
...
DROP POLICY IF EXISTS "Users can insert own schedule" ON public.billing_schedule;
...
DROP POLICY IF EXISTS "Users can view own schedule" ON public.billing_schedule;
...
DROP POLICY IF EXISTS "Users can delete own billing_settings" ON public.billing_settings;
...
DROP POLICY IF EXISTS "Users can insert own billing_settings" ON public.billing_settings;
...
DROP POLICY IF EXISTS "Users can update own billing_settings" ON public.billing_settings;
...
DROP POLICY IF EXISTS "Users can view own billing_settings" ON public.billing_settings;
CREATE POLICY "Users can view own billing_settings" ON public.billing_settings FOR SELECT TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users manage own bot flow sessions" ON public.bot_flow_sessions;
...
DROP POLICY IF EXISTS "owners manage own flows" ON public.bot_flows;
...
DROP POLICY IF EXISTS "Users manage own crm billing schedule" ON public.crm_oficial_billing_schedule;
...
DROP POLICY IF EXISTS "Users manage their own hidden CRM templates" ON public.crm_oficial_hidden_templates;
...
DROP POLICY IF EXISTS "Admins manage all crm_oficial_settings" ON public.crm_oficial_settings;
...
DROP POLICY IF EXISTS "Users manage their own crm_oficial_settings" ON public.crm_oficial_settings;
...
DROP POLICY IF EXISTS "Admins can manage backups" ON public.customer_backups;
...
DROP POLICY IF EXISTS "Users can create their own departments" ON public.departments;
...
DROP POLICY IF EXISTS "Owners delete own charges" ON public.efi_charges;
CREATE POLICY "Owners delete own charges" ON public.efi_charges FOR DELETE TO public USING (((auth.uid() = owner_id) OR is_admin()));
DROP POLICY IF EXISTS "Owners insert own charges" ON public.efi_charges;
...
DROP POLICY IF EXISTS "Owners update own charges" ON public.efi_charges;
...
DROP POLICY IF EXISTS "Users manage own evolution_billing_schedule" ON public.evolution_billing_schedule;
...
DROP POLICY IF EXISTS "Users manage own evolution_contacts" ON public.evolution_contacts;
...
DROP POLICY IF EXISTS "Users manage own evolution conversation state" ON public.evolution_conversation_state;
...
DROP POLICY IF EXISTS "Owner deletes own evolution_messages" ON public.evolution_messages;
...
DROP POLICY IF EXISTS "Owner views own evolution_messages" ON public.evolution_messages;
...
DROP POLICY IF EXISTS "Users view own presence" ON public.evolution_presence;
CREATE POLICY "Users view own presence" ON public.evolution_presence FOR SELECT TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users manage own evolution_settings" ON public.evolution_settings;
...
DROP POLICY IF EXISTS "stickers_own" ON public.evolution_stickers;
...
DROP POLICY IF EXISTS "Users can delete own goals" ON public.goals_settings;
CREATE POLICY "Users can delete own goals" ON public.goals_settings FOR DELETE TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users can insert own goals" ON public.goals_settings;
...
DROP POLICY IF EXISTS "Users can view own goals" ON public.goals_settings;
CREATE POLICY "Users can view own goals" ON public.goals_settings FOR SELECT TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Admins can delete message_logs" ON public.message_logs;
CREATE POLICY "Admins can delete message_logs" ON public.message_logs FOR DELETE TO public USING (is_admin());
DROP POLICY IF EXISTS "Admins can view all message_logs" ON public.message_logs;
...
DROP POLICY IF EXISTS "Admins can manage panel_links" ON public.panel_links;
CREATE POLICY "Admins can manage panel_links" ON public.panel_links FOR ALL TO public USING (is_admin());
DROP POLICY IF EXISTS "Authenticated users can view panel_links" ON public.panel_links;
...
DROP POLICY IF EXISTS "Users can delete payments for own customers" ON public.payments;
...
DROP POLICY IF EXISTS "Users can insert payments for own customers" ON public.payments;
CREATE POLICY "Users can insert payments for own customers" ON public.payments FOR INSERT TO public WITH CHECK ((is_admin() OR (EXISTS ( SELECT 1
   FROM customers
  WHERE ((customers.id = payments.customer_id) AND (customers.created_by = auth.uid()))))));
DROP POLICY IF EXISTS "Users can update payments for own customers" ON public.payments;
CREATE POLICY "Users can update payments for own customers" ON public.payments FOR UPDATE TO public USING ((is_admin() OR (EXISTS ( SELECT 1
   FROM customers
  WHERE ((customers.id = payments.customer_id) AND (customers.created_by = auth.uid()))))));
DROP POLICY IF EXISTS "Users can view payments for own customers" ON public.payments;
...
DROP POLICY IF EXISTS "Owners can delete own pending manual renewals" ON public.pending_manual_renewals;
...
DROP POLICY IF EXISTS "Owners can insert own pending manual renewals" ON public.pending_manual_renewals;
...
DROP POLICY IF EXISTS "Owners can view own pending manual renewals" ON public.pending_manual_renewals;
...
DROP POLICY IF EXISTS "Users can delete own quick_messages" ON public.quick_messages;
...
DROP POLICY IF EXISTS "Users can insert own quick_messages" ON public.quick_messages;
...
DROP POLICY IF EXISTS "Users can update own quick_messages" ON public.quick_messages;
...
DROP POLICY IF EXISTS "Users can view own quick_messages" ON public.quick_messages;
...
DROP POLICY IF EXISTS "Resellers can create sub-resellers" ON public.reseller_access;
...
DROP POLICY IF EXISTS "Resellers can delete their sub-resellers" ON public.reseller_access;
...
DROP POLICY IF EXISTS "Resellers can view their sub-resellers" ON public.reseller_access;
...
DROP POLICY IF EXISTS "Users can view own access" ON public.reseller_access;
CREATE POLICY "Users can view own access" ON public.reseller_access FOR SELECT TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Delete own unused access codes" ON public.reseller_access_codes;
...
DROP POLICY IF EXISTS "Insert own access codes" ON public.reseller_access_codes;
...
DROP POLICY IF EXISTS "Update access codes admin only" ON public.reseller_access_codes;
...
DROP POLICY IF EXISTS "View own access codes" ON public.reseller_access_codes;
...
DROP POLICY IF EXISTS "Users can delete own api settings" ON public.reseller_api_settings;
...
DROP POLICY IF EXISTS "Users can insert own api settings" ON public.reseller_api_settings;
...
DROP POLICY IF EXISTS "Users can update own api settings" ON public.reseller_api_settings;
...
DROP POLICY IF EXISTS "Users can view own api settings" ON public.reseller_api_settings;
...
DROP POLICY IF EXISTS "Admins manage all checkout settings" ON public.reseller_checkout_settings;
...
DROP POLICY IF EXISTS "Owner manages checkout settings" ON public.reseller_checkout_settings;
...
DROP POLICY IF EXISTS "Users can delete own servers" ON public.servers;
CREATE POLICY "Users can delete own servers" ON public.servers FOR DELETE TO public USING ((is_admin() OR (auth.uid() = created_by)));
DROP POLICY IF EXISTS "Users can insert own servers" ON public.servers;
...
DROP POLICY IF EXISTS "Users can view own servers" ON public.servers;
CREATE POLICY "Users can view own servers" ON public.servers FOR SELECT TO public USING ((auth.uid() = created_by));
DROP POLICY IF EXISTS "Admins update evo instances" ON public.user_evolution_instances;
CREATE POLICY "Admins update evo instances" ON public.user_evolution_instances FOR UPDATE TO public USING (is_admin());
DROP POLICY IF EXISTS "Users delete own evo instances" ON public.user_evolution_instances;
...
DROP POLICY IF EXISTS "Users insert own evo instances" ON public.user_evolution_instances;
...
DROP POLICY IF EXISTS "Users view own evo instances" ON public.user_evolution_instances;
...
DROP POLICY IF EXISTS "Users can delete own vplay_servers" ON public.vplay_servers;
CREATE POLICY "Users can delete own vplay_servers" ON public.vplay_servers FOR DELETE TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users can insert own vplay_servers" ON public.vplay_servers;
...
DROP POLICY IF EXISTS "Users can update own vplay_servers" ON public.vplay_servers;
CREATE POLICY "Users can update own vplay_servers" ON public.vplay_servers FOR UPDATE TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users can view own vplay_servers" ON public.vplay_servers;
...
DROP POLICY IF EXISTS "Users can view own webhook_logs" ON public.webhook_logs;
...
DROP POLICY IF EXISTS "Users can delete own xui_one_settings" ON public.xui_one_settings;
...
DROP POLICY IF EXISTS "Users can insert own xui_one_settings" ON public.xui_one_settings;
...
DROP POLICY IF EXISTS "Users can update own xui_one_settings" ON public.xui_one_settings;
...
DROP POLICY IF EXISTS "Users can view own xui_one_settings" ON public.xui_one_settings;
CREATE POLICY "Users can view own xui_one_settings" ON public.xui_one_settings FOR SELECT TO public USING ((auth.uid() = user_id));
DROP POLICY IF EXISTS "Users can delete own zap_responder_settings" ON public.zap_responder_settings;
...
DROP POLICY IF EXISTS "Users can insert own zap_responder_settings" ON public.zap_responder_settings;
...
DROP POLICY IF EXISTS "Users can update own zap_responder_settings" ON public.zap_responder_settings;
...
DROP POLICY IF EXISTS "Users can view own zap_responder_settings" ON public.zap_responder_settings;
...
-- Policies de Storage
DROP POLICY IF EXISTS "Authenticated can update meta-template-uploads" ON storage.objects;
...
DROP POLICY IF EXISTS "Authenticated can upload meta-template-uploads" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can delete own evolution media" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can delete own reseller assets" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can read own evolution media" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can update own evolution media" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can upload own evolution media" ON storage.objects;
...
DROP POLICY IF EXISTS "Users can upload own reseller assets" ON storage.objects;
