...
CREATE TABLE public.ai_knowledge_candidates (
  ...
  similar_questions ARRAY DEFAULT '{}'::text[],
  ...
  status text NOT NULL DEFAULT 'pending'::text,
  source_conversation_ids ARRAY DEFAULT '{}'::uuid[],
  embedding vector,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now()
);
...
CREATE TABLE public.ai_knowledge_items (
  ...
  category text NOT NULL DEFAULT 'outros'::text,
  devices ARRAY NOT NULL DEFAULT '{}'::text[],
  apps ARRAY NOT NULL DEFAULT '{}'::text[],
  ...
  source_conversation_ids ARRAY NOT NULL DEFAULT '{}'::uuid[],
...
CREATE TABLE public.evolution_settings (
  ...
  autoreply_disabled_phones ARRAY NOT NULL DEFAULT '{}'::text[],
...
CREATE TABLE public.user_evolution_instances (
  ...
  webhook_events ARRAY NOT NULL DEFAULT ARRAY['MESSAGE'::text, 'SEND_MESSAGE'::text, 'CONNECTION'::text, 'PRESENCE'::text, 'CHAT_PRESENCE'::text],
