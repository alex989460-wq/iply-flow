      ...
      if (action === "public-catalog") {
        ...
        return json({
          ...
          servers: (servers || []).map((server: any) => {
            ...
            return { ...server, automatic_delivery: panel.includes("natv") || panel.includes("pixbot") || panel.includes("thebest") || panel.includes("the best") || panel.includes("painel.best") || panel.includes("vplay") || panel.includes("rush") || panel.includes("paineloffice") };
          }),
          tiers: tiers || [],
        });
      }
